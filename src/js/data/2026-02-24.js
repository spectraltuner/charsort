dataSetVersion = "2026-02-24"; // Change this when creating a new data set version. YYYY-MM-DD format.
...
dataSet[dataSetVersion].options = [
  {
    ...
    sub: [
      ...
      { name: "Magical Girl Wars", tooltip: "I Swear This Isn't Just an Excuse for Ryona", key: "MGW" },
  ...
  },
{
  ...
  {
    name: "Gallant Destrier (Marie-Pierre Chevalier)",
    img: "YPK7wgJ.png",
    opts: {
      series: [ "MGW" ],
      tri: true,
